...
/*   Updated: 2021/03/28 16:32:43 by qmalcom          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int						put_message(t_philo *philo, const char *mess,
															int count);
int						put_fork_message(t_philo *philo);
int						put_eating_message(t_philo *philo);
int						put_sleeping_message(t_philo *philo);
int						put_thinking_message(t_philo *philo);
