...
{
	std::cout << "Perfect NINJA robot " << get_name() << " created" << std::endl;
	return;
}
...
NinjaTrap::NinjaTrap(std::string name)
{
	...
	std::cout << "Perfect Ninja robot " << this->get_name() << " created" << std::endl;
	return;
}
...
NinjaTrap::~NinjaTrap(void)
{
	std::cout << this->get_name() << " rotted in the dustbin of the universe (NinjaTrap)"  << std::endl;
	return;
}
